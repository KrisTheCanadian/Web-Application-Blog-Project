...
from app import app, db, bcrypt, mail, MAIL_USER
...
def register():
    ...
    if form.validate_on_submit():
        ...
        db.session.add(user)
        db.session.commit()
        flash(f"{form.username.data}, your account has been successfully registered!", 'success')
...
@app.route("/post/<int:post_id>")  # expecting an integer
def post(post_id):
